document.addEventListener("DOMContentLoaded", () => {
    ...
    function checkBoard() {
        // get each array container
        for (let y = 0; winningArrays.length; y++) {
            // get array elements from array container
    ...
    for (let i = 0; i < squares.length; i++) { 
        ...
        squares[i].onclick = () => {
            //alert("You have clicked on square: " + i)
            //if the sqaure below is your current square is taken, you can go on top of it
            if (squares[i + 7].classList.contains("taken") && !squares[1].classList.contains("taken")) {
                if (currentPlayer == 1) {
